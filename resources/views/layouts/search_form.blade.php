<form action="{{ route('reservation.create') }}" method="GET" class="row g-3" novalidate>
    ...
    <div class="col-6 col-md-3 col-xl-4">
        ...
        <x-text-input type="date" name="check_out_date" id="check_out_date" class="mt-1 block w-full" :value="old('check_out_date', \Carbon\Carbon::tomorrow()->addDays(1)->toDateString())" min="{{ \Carbon\Carbon::tomorrow()->toDateString() }}" />
    </div>
    <div class="col-6 col-md-3 col-xl-2">
        <x-input-label for="number_of_guests" :value="__('Number of Guests')" />
        <x-text-input type="number" name="number_of_guests" id="number_of_guests" class="mt-1 block w-full" :value="old('number_of_guests', 1)" min="1" max="4" />
    </div>
