<div class="sm:flex gap-4">
    ...
    <div class="flex content-center justify-between sm:grow">
        <div class="flex items-center me-4">
            <svg class="w-5 h-5 text-gray-800 dark:text-white me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <button class="text-gray-600 mx-4 border-b-2 hover:border-indigo-400" type="button" data-drawer-target="drawer-top-search" data-drawer-show="drawer-top-search" data-drawer-placement="top" data-drawer-body-scrolling="true" aria-controls="drawer-top-search">
            {{ __('Edit Stay') }}
        </button>
    </div>
</div>
